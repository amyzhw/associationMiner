...
import nlp.associationMiner.fig.StopWatch;
  ...
  public FbEntitySearcher(String indexDir, int numOfDocs, String searchingStrategy) throws IOException {
    ...
    queryParser = new QueryParser(
       // Version.LUCENE_6_2_1,
        ...
        //searchingStrategy.equals("exact") ? new KeywordAnalyzer() : new StandardAnalyzer(Version.LUCENE_6_2_1)
        new StandardAnalyzer());
    LogInfo.log("Opening index dir: " + indexDir);
    Path path = Paths.get(indexDir);
    IndexReader indexReader = DirectoryReader.open(SimpleFSDirectory.open(path));
