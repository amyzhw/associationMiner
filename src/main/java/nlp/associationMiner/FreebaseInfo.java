...
import nlp.associationMiner.FbFormulasInfo.UnaryFormulaInfo;
...
public class FreebaseInfo {
  ...
  public void readSchema() throws NumberFormatException, IOException {
    ...
    while ((line = in.readLine()) != null) {
      String[] tokens = nlp.associationMiner.freebase.Utils.parseTriple(line);
      ...
      if (property.equals("fb:type.property.reverse_property")) {
        ...
        bPopularityMap.put(arg1, nlp.associationMiner.freebase.Utils.parseInt(arg2));
      } else if (property.equals("fb:user.custom.people.person.profession.num_instances")) {
        professionPopularityMap.put(arg1, nlp.associationMiner.freebase.Utils.parseInt(arg2));
      } else if (property.equals("fb:user.custom.type.object.type.num_instances")) {
        typePopularityMap.put(arg1, nlp.associationMiner.freebase.Utils.parseInt(arg2));
      }   
    }
    in.close();
    ...
    while ((line = in.readLine()) != null) {
      ...
      if(property.equals(NAME) || property.equals(ALIAS)) {
        if(bPopularityMap.containsKey(arg1)) {
          MapUtils.addToList(bDescriptionsMap, arg1, nlp.associationMiner.freebase.Utils.parseStr(arg2).toLowerCase());
        }
        else if(professionPopularityMap.containsKey(arg1)) {
          MapUtils.addToList(professionDescriptionsMap, arg1, nlp.associationMiner.freebase.Utils.parseStr(arg2).toLowerCase());
        }
        else if(typePopularityMap.containsKey(arg1)) {
          MapUtils.addToList(typeDescriptionsMap, arg1, nlp.associationMiner.freebase.Utils.parseStr(arg2).toLowerCase());
        }  
      } 
    }
